        ...
        <header className="h-14 bg-white border-b border-border-light px-6 flex items-center justify-between z-10">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-text-main bg-slate-100 hover:bg-slate-200 rounded-lg border border-border-light transition-all shadow-2xs cursor-pointer"
            ...
            <button
              onClick={handleLogout}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-rose-700 bg-rose-50 hover:bg-rose-100 rounded-lg border border-rose-200 transition-all shadow-2xs cursor-pointer"
